...
class JobSettings(BaseJobSettings):
    ...
    session_start_time: Optional[datetime] = Field(default=None, title="Start time of the session (optional, will be extracted from data if not provided)")
    session_end_time: Optional[datetime] = Field(default=None, title="End time of the session (optional, will be extracted from data if not provided)")
