...
class TestFiberPhotometryLegacyExtractor(unittest.TestCase):
    ...
    def test_extract_metadata_success(self):
        ...
        with patch.object(extractor, '_extract_session_start_time', 
    ...
    def test_file_glob_pattern(self):
        ...
        fibpho_file2 = self.test_data_dir / "2024-01-15_15-00-00_mouse_001_fibpho.txt"
    ...
    def test_extract_metadata_with_timing_error(self):
        ...
        with patch.object(extractor, '_extract_session_start_time', 
                         side_effect=FileNotFoundError("No timing files found")):
