...
class TestCamstim(unittest.TestCase):
    ...
    @patch("aind_metadata_extractor.utils.camstim_sync.sync.get_ophys_stimulus_timestamps")  # noqa
    ...
    @patch("aind_metadata_extractor.utils.camstim_sync.names.map_column_names")
    @patch("pandas.DataFrame.to_csv")
    ...
    @patch("aind_metadata_extractor.utils.camstim_sync.names.collapse_columns")
    @patch("aind_metadata_extractor.utils.camstim_sync.names.drop_empty_columns")
    @patch("aind_metadata_extractor.utils.camstim_sync.names.standardize_movie_numbers")
    @patch("aind_metadata_extractor.utils.camstim_sync.names.add_number_to_shuffled_movie")  # noqa
    @patch("aind_metadata_extractor.utils.camstim_sync.names.map_stimulus_names")
