...
class TestBehaviorUtils(unittest.TestCase):
    ...
    @patch("aind_metadata_extractor.utils.camstim_sync" ".behavior_utils.stim.convert_filepath_caseinsensitive")
    @patch("aind_metadata_extractor.utils.camstim_sync" ".behavior_utils.stim.get_image_set_name")
